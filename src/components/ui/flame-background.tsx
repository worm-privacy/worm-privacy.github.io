...
export const SparksDriftingShaders = forwardRef<HTMLDivElement, SparksDriftingShadersProps>(
  ({ className, speed = 1.0, sparkSize = 1.0, fireIntensity = 1.0, smokeIntensity = 1.0, ...props }, ref) => {
    return (
      <div ref={ref} className={cn('h-full w-full', className)} {...props}>
        <Shader
          ...
          uniforms={{
            ...
            u_sparkSize: { type: '1f', value: sparkSize },
            u_fireIntensity: { type: '1f', value: fireIntensity },
            u_smokeIntensity: { type: '1f', value: smokeIntensity },
          }}
...
SparksDriftingShaders.displayName = 'SparksDriftingShaders';
