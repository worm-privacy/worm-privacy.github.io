...
const buttonVariants = cva(
  'relative inline-flex items-center justify-center gap-1 whitespace-nowrap transition-all disabled:pointer-events-none [&_svg]:pointer-events-none shrink-0 [&_svg]:shrink-0 outline-none rounded-base cursor-pointer',
  {
    variants: {
      variant: {
        primary:
          'text-black bg-brand aria-invalid:border-destructive focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20',
        'primary-link': 'text-black bg-brand',
        'primary-outline': 'text-brand border border-brand/24 bg-surface1',
        outline:
        ...
        link: 'text-white before:pointer-events-none before:absolute before:left-0 before:bottom-2 before:bg-brand/24 before:h-[0.05em] before:w-full before:content-[""] before:origin-right before:scale-x-0 before:transition-transform before:duration-300 before:ease-[cubic-bezier(0.4,0,0.2,1)] before:origin-center hover:before:scale-x-100 hover:text-gray-300 px-0!',
