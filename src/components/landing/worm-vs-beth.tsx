...
export function WormVSBethSection() {
  ...
  return (
    <section className="mx-auto flex w-full flex-col items-start gap-8 px-4 py-12 pb-32 md:items-center md:px-0 md:pt-0 xl:max-w-280.5">
      <h1
        className={cn('orbitron-h2 text-green-400 uppercase', {
      ...
      <div className="grid w-full grid-cols-1 gap-6 md:grid-cols-2 md:gap-0">
        <div className="flex flex-col items-start gap-4 md:flex-row md:items-center md:gap-7">
          <div className="relative md:h-113.75 md:w-58 md:rounded-xl md:border-3 md:border-green-500/36">
            <h1
              className={cn(
        ...
        <div className="flex flex-col-reverse items-end gap-4 md:flex-row md:items-center md:gap-7">
          <div className="flex flex-col gap-4 text-white md:gap-6">
            ...
            <ul
              className={cn(
                ...
                '[&>li]:before:absolute [&>li]:before:top-1/2 [&>li]:before:-right-10.5 [&>li]:before:size-6 [&>li]:before:-translate-y-1/2 [&>li]:before:rounded-full [&>li]:before:bg-blue-900 [&>li]:before:content-[""]',
                '[&>li]:after:absolute [&>li]:after:top-1/2 [&>li]:after:-right-9 [&>li]:after:size-3 [&>li]:after:-translate-y-1/2 [&>li]:after:rounded-full [&>li]:after:bg-blue-300 [&>li]:after:content-[""]',
                {
                  '[&>li]:before:hidden [&>li]:after:hidden': isMobile,
                }
              )}
          ...
          <div className="relative md:h-113.75 md:w-58 md:rounded-xl md:border-3 md:border-blue-500/36">
            <h1
              className={cn(
      ...
      <div className="mt-24 flex size-full items-center justify-center rounded-lg bg-surface1 px-4 py-6 md:h-67.25 md:w-137 md:px-8 md:py-6">
        <p className="orbitron-h4 relative flex items-center gap-3 text-white">
          ...
          <span className="absolute -top-full right-0">
            <Svg
              src="/assets/icons/arrow.svg"
              className="absolute -top-6 right-0 -rotate-30 md:-right-12 md:rotate-0"
            />
            <span className="satoshi-body3 absolute -top-16 -right-12 w-32 text-gray-400 md:-top-16 md:-right-32">
          ...
          <span className="absolute right-0 -bottom-full">
            <Svg
              src="/assets/icons/arrow.svg"
              className="absolute right-15 -bottom-6 rotate-150 md:-left-8 md:rotate-120"
            />
            <span className="satoshi-body3 absolute -right-14 -bottom-18 w-31 text-gray-400 md:-right-26 md:-bottom-20">
          ...
          <span className="absolute -bottom-full">
            <Svg
              src="/assets/icons/arrow.svg"
              className="absolute -bottom-6 left-2 rotate-150 md:-left-8 md:rotate-180"
            />
